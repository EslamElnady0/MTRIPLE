          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('You can manage your account on this page',
...
child: Column(
  ...
  children: [
    row(text: 'Change Language' , widget: Row(
      children: [
        Text('EN',style: Styles.style16whiteBold,),
    ...
    SizedBox(height: 30.h,),
    row(text: 'Notifications' , widget: const  Icon(Icons.notifications,color: MainColors.white,)),
    SizedBox(height: 30.h,),
    row(text: 'Feedback',widget: SvgPicture.asset('assets/images/feedback.svg'),
    ),
    SizedBox(height: 30.h,),
    row(text: 'Confidentiality' , widget: const  Icon(Icons.arrow_forward_ios_outlined,color: MainColors.white,)),
    SizedBox(height: 30.h,),
    row(text: 'Log out' ,widget:  InkWell(
        onTap: ()
        {
          // Navigator.pushNamedAndRemoveUntil(
          //     context, Routes.authStart, (route) => false);
        },
        child: Icon(Icons.logout,color: MainColors.white,))),
  ],
),
                ),
  ...
  Widget row({
    ...
    children: [
      Text(text,style: Styles.style20whiteBold,),
     const Spacer(),
      widget,
